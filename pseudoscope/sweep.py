...
from pseudoscope.analysis import FunctionAnalysisOutcome, analyze_function
from pseudoscope.discover import DiscoverError, DiscoveredFunction, discover_functions
